            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">purchase autoaccessories</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row" style=" padding-top: 3%;">
            <div class="col-lg-12 col-md-12">
                <div class="impl_heading">
                    <h1 class="topic">Beep autoaccessories</h1></br>
                    <div class="row">
                    ...
                    <div class="row" style="padding-left: 5%; margin-left: 13.5%; padding-top: 1%;">
                        <a class="imgtext-1">Motor Vehicle Accessories</a>
                        <a class="imgtext-2">Motorbike Accessories</a>
                        <a class="imgtext-3">Tuk Accessories</a>
                        <a class="imgtext-4">Machinery Accessories</a>
                        <a class="imgtext-5">Other Accessories</a>
                                ...
                                <div class="impl_sidebar">
                                    ...
                                    <div class="impl_product_brand widget woocommerce">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <label class="brnds_check_label">
                                                    Bodykits & Modification Accessories
                                                    <input type="checkbox" name="check">
                                                    <span class="label-text"></span>
                                                </label>
                                            </li>
